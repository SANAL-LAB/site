...
<div class="product-view">
	...
	<!--++++++++++++-->
	<div id="wrap" style="top:0px;z-index:9;position:relative;"><a href="uploads/urunler/<?php echo $urun->resim;?>" class="" id="" >
		<img style="display: block;" src="uploads/urunler/<?php echo $urun->resim;?>" alt="pleasure" title="">	</a><div class="" ></div></div>
</p>
		...
		<div class="availerble">
         <p>Ders Kodu: <?php echo $urun->urun_kodu;?></p>
...
<div class="box-collateral box-reviews row" id="customer-reviews">
	...
	<div id="taksit" class="tab-panel">
      ...
      <p>Dersi satın aldıktan 15 gün içinde <?php echo $ayar->firma_tel; ?> numaramızdan müşteri hizmetlerimizle irtibata geçerek iade sürecinizi başlatabilirsiniz.</p> 
									<p>Kitaplar için iade talebinizin kabul edilmesi için, kitabın hasar görmemiş ve kullanılmamış olması gerekmektedir.</p> 
