...
<div class="block-testimonial-sidebar">			
			...
			<div class="bg-title"><h2><i class="fa fa-bookmark"></i>DERS YORUMLARI</h2></div>
		</div>
...
<div class="std"><div class="home-content"><div class="featuredproduct">
	...
	<div class="featured-title bx-title"><div class="bg-title"><h2 class="title">FIRSAT DERSLER</h2></div></div>				<div class="slide-multirows">
...
<div class="newproductslider">
	<div class="bx-title new-title"><div class="bg-title"><h2>YENİ DERSLER</h2></div></div>		
...
<script type="text/javascript">
	...
	<div class="bestsellerslider">
		<div class="container">
		<div class="bx-title bestseller-title"><div class="bg-title"><h2><i class="fa fa-bookmark"></i>SON EKLENEN DERSLER</h2></div></div>			
