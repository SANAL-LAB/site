 ...
 <!-- Javascript --> 
   ...
   <body class="skin-yellow layout-boxed">
    <div class="wrapper">
					 ...
					 while($MesajSonuc = Sonuc($MesajSorgu)){?>
                      <li><!-- start message -->
                        <a href="mesaj-oku.html?id=<?php echo $MesajSonuc->id; ?>">
                          <div class="pull-left">
                            <img src="dist/img/user2-160x16.jpg" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
      ...
      <aside class="main-sidebar">
        ...
        <div class="pull-left image">
          <img kasperskylab_antibanner="on" src="dist/img/user2-160x16.jpg" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          ...
          <a href="yonetici-listele.html"><i class="fa fa-circle text-success"></i> Çevrimiçi</a>
			...
			<!---------------------------------------------------------------------------->
            <li class="treeview <?php echo aktif("reklam-ekle.html"); ?> <?php echo aktif("reklam-listele.html"); ?>">
              <a href="#">
                <i class="fa fa-eye"></i> <span>Reklam Yönetimi</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
				
                <li class="<?php echo aktif("reklam-listele.html"); ?>">
                	<a href="reklam-listele.html"><i class="fa fa-circle-o"></i> Reklam Listesi</a>
                </li>
              </ul>
            </li>
			<!---------------------------------------------------------------------------->
            <li class="treeview <?php echo aktif("etiket-ekle.html"); ?> <?php echo aktif("etiket-listele.html"); ?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li class="<?php echo aktif("etiket-ekle.html"); ?>">
                	<a href="etiket-ekle.html"><i class="fa fa-circle-o"></i> Etiket Ekle</a>
                </li>
                <li class="<?php echo aktif("etiket-listele.html"); ?>">
                	<a href="etiket-listele.html"><i class="fa fa-circle-o"></i> Etiket Listesi</a>
                </li>
              </ul>
            </li>
			<!---------------------------------------------------------------------------->
            ...
            <li class="treeview <?php echo aktif("urun-kategori-ekle.html"); ?> <?php echo aktif("urun-kategori-listele.html"); ?> <?php echo aktif("urun-alt-kategori-ekle.html"); ?> <?php echo aktif("urun-alt-kategori-listele.html"); ?> <?php echo aktif("urun-ekle.html"); ?> <?php echo aktif("urun-listele.html"); ?>">
              <a href="#">
                <i class="fa fa-tasks"></i> <span>Ders Yönetimi</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                ...
                <li class="<?php echo aktif("urun-ekle.html"); ?>">
                	<a href="urun-ekle.html"><i class="fa fa-circle-o"></i> Ders Ekle</a>
                </li>
                <li class="<?php echo aktif("urun-listele.html"); ?>">
                	<a href="urun-listele.html"><i class="fa fa-circle-o"></i> Ders Listesi</a>
                </li>
              </ul>
            </li>
			<!---------------------------------------------------------------------------->
			...
			<li class="treeview <?php echo aktif("marka-ekle.html"); ?> <?php echo aktif("marka-listele.html"); ?>">
              <a href="#">
                <i class="fa fa-bookmark"></i> <span>Yayınevi Yönetimi</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="<?php echo aktif("marka-ekle.html"); ?>">
                	<a href="marka-ekle.html"><i class="fa fa-circle-o"></i> Yayınevi Ekle</a>
                </li>
                <li class="<?php echo aktif("marka-listele.html"); ?>">
                	<a href="marka-listele.html"><i class="fa fa-circle-o"></i> Yayınevi Listesi</a>
                </li>
              </ul>
            </li>
            ...
            <!---------------------------------------------------------------------------->
            <li class="treeview <?php echo aktif("yorum-ekle.html"); ?> <?php echo aktif("yorum-listele.html"); ?> <?php echo aktif("urun-yorum-ekle.html"); ?> <?php echo aktif("urun-yorum-listele.html"); ?>">
              <a href="#">
                <i class="fa fa-eye"></i> <span>Yorum Yönetimi</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
         
				<li class="<?php echo aktif("urun-yorum-ekle.html"); ?> <?php echo aktif("urun-yorum-listele.html"); ?>">
                	<a href="urun-yorum-listele.html"><i class="fa fa-circle-o"></i>Ders Yorum Listesi</a>
                </li>
              </ul>
            </li>
			<!---------------------------------------------------------------------------->
            ...
            <!---------------------------------------------------------------------------->
			<li class="<?php echo aktif("ebulten.html"); ?>">
              <a href="ebulten.html">
                <i class="fa fa-envelope-o"></i> <span>Ebülten</span>
              </a>
	...
	if(isset($_GET['sayfa'])){
		...
		case 'kapida-odeme';
		require_once("sayfalar/kapida_odeme.php");
		break;
...
?> 
      ...
      <footer class="main-footer">
        ...
        <strong><?php echo $ayar->copyright; ?></strong>
      </footer>
    </div><!-- ./wrapper -->
    <!--file upload-->
