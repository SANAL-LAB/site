...
if(p('kategori_adi') && g('islem')=="")
{
	...
	$upload->image_x = 100;
	$upload->image_y = 100;
	$upload->process("../skin/frontend/tv_arion_package/tv_arion/themevast/megamenu/images");
...
if(p('kategori_adi') && g('islem')=="duzenle")
{
	...
	if($UrunKategoriResim!="")
	{
		...
		$resim_sil	=	unlink("../skin/frontend/tv_arion_package/tv_arion/themevast/megamenu/images/".$resim_bul->resim);
