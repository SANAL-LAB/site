...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-tasks"></i> Ders Ekle / Düzenle</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="anasayfa.html"><i class="fa fa-home"></i> Anasayfa</a></li>
            <li class="active">Ders Ekle / Düzenle</li>
          </ol>
        </section>
        <!-- Main content -->
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  ...
                  <!-------------------------------------------------------------------------------------->
                    <div class="form-group">
                      <label for="urun_adi">Ders Adı</label>
                      <input type="text" class="form-control" name="urun_adi" value="<?php echo $UrunSonuc->adi;?>" id="urun_adi" placeholder="Ders Adı">
                    </div>
                    <!-------------------------------------------------------------------------------------->
                    <div class="form-group">
                    ...
                    <!-------------------------------------------------------------------------------------->
                    <div class="form-group">
                      <label for="urun_kodu">Ders Kodu</label>
                      <input type="text" class="form-control" name="urun_kodu" value="<?php echo $UrunSonuc->urun_kodu;?>" id="urun_kodu" placeholder="Ders Kodu">
                    </div>
					<!-------------------------------------------------------------------------------------->
					<div id="xnxx">
					<?php 
                    ...
                    <div class="form-group " style="float:left;">
						       ...
						       <div class="form-group">
                      <label>Çok Satanlar</label>
                      <select class="form-control" name="cok" id="cok">
                      <option value="0">Seçiniz</option>
    ...
    <option value="Hayır">Hayır</option>
                      ...
                      <option value="<?=$UrunSonuc->cok;?>" <?php if($UrunSonuc->cok == $UrunSonuc->cok) { ?> selected="selected" <?php } ?>>Seçili >>><?=$UrunSonuc->cok;?></option>
									       ...
									       <div class="form-group">
                      <label>Sıcak Fırsatlar</label>
                      <select class="form-control" name="sicak" id="sicak">
                      <option value="0">Seçiniz</option>
					  <option value="Evet">Evet</option>
    <option value="Hayır">Hayır</option>
                      ...
                      <option value="<?=$UrunSonuc->sicak;?>" <?php if($UrunSonuc->sicak == $UrunSonuc->sicak) { ?> selected="selected" <?php } ?>>Seçili >>><?=$UrunSonuc->sicak;?></option>
							       ...
							       <div class="form-group">
                      <label>Yeni Dersler</label>
                      <select class="form-control" name="yeni" id="yeni">
                      <option value="0">Seçiniz</option>
					  <option value="Evet">Evet</option>
    <option value="Hayır">Hayır</option>
                      ...
                      <option value="<?=$UrunSonuc->yeni;?>" <?php if($UrunSonuc->yeni == $UrunSonuc->yeni) { ?> selected="selected" <?php } ?>>Seçili >>><?=$UrunSonuc->yeni;?></option>
