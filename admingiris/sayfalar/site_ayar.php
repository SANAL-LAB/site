                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <option value="multicolor" <?php echo $ayar_dizi->tema == 'grey' ? 'selected' : '';?>>Gri</option> 
                      <option value="red" <?php echo $ayar_dizi->tema == 'red' ? 'selected' : '';?>>Kırmızı</option>  
                      <option value="green" <?php echo $ayar_dizi->tema == 'green' ? 'selected' : '';?>>Yeşil</option> 
                      <option value="yellow" <?php echo $ayar_dizi->tema == 'yellow' ? 'selected' : '';?>>Sarı</option> 
                      <option value="blue" <?php echo $ayar_dizi->tema == 'blue' ? 'selected' : '';?>>Mavi</option> 
                      <option value="lacivert" <?php echo $ayar_dizi->tema == 'lacivert' ? 'selected' : '';?>>Lacivert</option>  
    <option value="mor" <?php echo $ayar_dizi->tema == 'mor' ? 'selected' : '';?>>Mor</option>  
    <option value="turkuaz" <?php echo $ayar_dizi->tema == 'turkuaz' ? 'selected' : '';?>>Turkuaz</option>  
    <option value="pembe" <?php echo $ayar_dizi->tema == 'pembe' ? 'selected' : '';?>>Pembe</option>  
    <option value="portakal" <?php echo $ayar_dizi->tema == 'portakal' ? 'selected' : '';?>>Portakal</option>  	
                      </select>
                    </div>
					 <!-------------------------------------------------------------------------------------->
					<div class="form-group">
                    ...
                    <!-------------------------------------------------------------------------------------->
                     ...
                     <div class="form-group">
                    <label for="firma_adres">Ön Mesafeli Bilgilendirme Formu </label>
                    <textarea class="textarea" id="icerik" name="obilgi" placeholder=""><?php echo $ayar_dizi->obilgi;?></textarea>
                    </div>      
                     <div class="form-group">
                    <label for="firma_adres">Satış Sözleşmesi</label>
                    <textarea class="textarea" id="icerik" name="satis" placeholder=""><?php echo $ayar_dizi->satis;?></textarea>
                    </div>      
                    ...
                    <div class="form-group">
                      <label for="renk">Youtube Sayfa URL</label>
                      <input type="text" class="form-control" name="renk" value="<?php echo $ayar_dizi->renk;?>" id="renk" placeholder="Youtube Sayfa URL">
                    </div>
					<div class="form-group">
                      <label for="pinterest">Skype Adresiniz</label>
                      <input type="text" class="form-control" name="pinterest" value="<?php echo $ayar_dizi->pinterest;?>" id="pinterest" placeholder="Skype Adresiniz">
                    </div>
					
					<div class="form-group">
                      <label for="instagram">İnstagram Sayfa URL</label>
